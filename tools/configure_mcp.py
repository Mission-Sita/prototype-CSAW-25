...
MCP_SERVERS = [
    ...
    # these are the tools extra mcp servers 
    #args need to be updated to match the actual mcp server implementations
    {
        "name": "Volatility MCP Server",
        "key": "Volatility",
        "command": "python",
        "args": ["/path/to/volatility_mcp_server.py","--transport", "stdio"],
        "description": "MCP server for memory forensics using Volatility 3.",
        "exe_name": "vol.py",
        "env_var": "VOLATILITY_PATH",
        "homepage": "https://github.com/bornpresident/Volatility-MCP-Server.git"
    },
  {
        "name": "Hashcat MCP Server",
        "key": "Hashcat-MCP",
        "command": "python",
        "args": ["/home/ram/Hashcat-MCP/hashcat_mcp_server.py","--transport", "stdio"],
        "description": "MCP server wrapper for Hashcat password cracking automation.",
        "exe_name": "hashcat.exe",
        "env_var": "HASHCAT_PATH",
        "env_extra": {
            "HASHCAT_SAFE_DIRS" : "/home/ram/wordlists",
            "HASHCAT_TMP_PATH": "/home/ram/wordlists/tmp"

        },#enter this manually
        "homepage": "https://github.com/MorDavid/Hashcat-MCP"
    },
    {
        "name": "Ghidra",
        "key": "GhidraMCP",
        "command": "python",
        "args": [
            "/home/ram/GhidraMCP/bridge_mcp_ghidra.py",
            "--ghidra-server",
            "http://127.0.0.1:8080/"
        ],
        "description": "MCP server for Ghidra to enable reverse engineering, disassembly, decompilation, and automated analysis.",
        "exe_name": None,  # Uses Python bridge script, no standalone binary
        "env_var": "",  # Change/remove if GhidraMCP doesn’t require authentication
        "env_extra": {
            "GHIDRA_SERVER": "http://127.0.0.1:8080/",
            "WORKSPACE_DIR": "workspace"  # Adjust if the bridge requires a workspace directory
        },
